...
class MinesweeperAI():
    ...
    def cell_neighbors(self, cell):
        """
        Return's a set of all the cell's neighboring cells.
        """
        neighbors = set()
        ...
        for sentence1 in self.knowledge:
            for sentence2 in self.knowledge:
                ...
                if sentence1.cells.issubset(sentence2.cells):
                    ...
                    new_st = Sentence(new_cells, new_count)
                    new_knowledge.append(new_st)
    ...
    def get_optimal_cells(self):
        optimal_cells = None
        diff = 3

        for st in self.knowledge:
            df = len(st.cells) - st.count
            if df >= diff:
                optimal_cells = st.cells
                diff = df
